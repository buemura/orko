...
- [Observability](/agents/observability) — monitor agent lifecycle events.
- [Dynamic Router](/agents/router) — LLM-based dynamic routing for N-path branching.
- [Supervisor / Worker](/agents/supervisor) — delegate tasks to specialized worker agents.
- [Debate](/agents/debate) — multi-agent collaboration and debate over multiple rounds.
